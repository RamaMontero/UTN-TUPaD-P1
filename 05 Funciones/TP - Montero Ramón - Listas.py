...
mis_elementos = ["pizza", "película", "viaje", "música", "fútbol"]
...
numeros = [8, 15, 3, 22, 7] #Esta es la lista inicial
numeros.remove (max(numeros)) #con max(numeros) se busca el número mas grande que es el 22 y se remueve con numeros.remove()
